...
<table class="table table-bordered">
	<thead>
		<tr>
			<th colspan="2">
				<center>
				<img src="images/athididevobhava.png" alt="" width="250px;" style="height:50px;"><br>
				Atithi Devo Bhava<br>
				#124 Gate, Gyan Market<br>
				Bangalore
				</center>
			</th>
		</tr>
...
<tbody>
	...
	?>
	<tr>
		<td class="text-right"><h4><strong>Sub Total: </strong></h4></td>
		<td class="text-left text-danger"><h4>Rs. <?php echo $rspayment['total_amt']; ?></strong></h4></td>
	</tr>
	<tr>
		<td class="text-right"><h4><strong>Discount Amount: </strong></h4></td>
		<td class="text-left text-danger"><h4>Rs. <?php echo $rspayment['discount_amount']; ?></strong></h4></td>
	</tr>
	<tr>
		<td class="text-right"><h4><strong>Total Amount: </strong></h4></td>
		<td class="text-left text-danger"><h4>Rs. <?php echo $totamt = $rspayment['total_amt'] - $rspayment['discount_amount']; ?></strong></h4></td>
	</tr>
	<?php
	}
	else
	...
	<tr>
		...
		<td class="text-left text-danger"><h2>Rs. <?php echo $totamt = $rspayment['total_amt']; ?></strong></h2></td>
	</tr>
	<?php
	}
	?>
