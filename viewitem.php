...
<table id="datatable" class="table table-striped table-bordered" >
	...
	<tbody>
	<?php
	$sql ="SELECT item.*,tourism_location.location_name,food_category.food_category FROM item LEFT JOIN tourism_location ON item.location_id=tourism_location.location_id LEFT JOIN food_category ON food_category.food_category_id=item.food_category_id";
	$qsql =mysqli_query($con,$sql);
