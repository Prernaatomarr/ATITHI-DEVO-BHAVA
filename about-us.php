                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="about-us">
                                    ...
                                    <div class="mg_hotel_hd1 text-left">
                                        <h6>Enjoy A Memorable days</h6>
                                        <h4>About us</h4>
                                    </div>
                                    <!-- iqoniq Heading End -->
                                    <div class="text">
<p>The main purpose of the project is to provide information about tours and travels Mainly this website provide complete information about tourism places with facilities, location map, contact details. Even it allows customer to book lodges, Cabs and Food order through online. Customer can ask all kinds of query and they can post travel experiences in the comment box. </p>
<p>This project is to provide user friendly hotel booking and service portal which helps customers as well as management. In this project customer can search for hotels or lodges and they can book hotel rooms along with hotel services. Services like cab services, food order services can be booked through online.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="mg_hotel_hd1">
                            <h4>Know More About Atithi Devo Bhava</h4>
                        </div>
                        <!-- iqoniq Heading End -->
                        <div class="row">
